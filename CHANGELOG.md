...
- Added `ItemList` type under `Intangible` along with unit tests and documentation.
- Made `BreadcrumbList` extend `ItemList`.

## 0.4.0 - 2026-09-12

### Changed

- Change default value for bundle configuration option `pretty_print` to `'%kernel.debug%'`.
